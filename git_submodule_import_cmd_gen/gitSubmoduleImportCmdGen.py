...
def main_cmd():
    ...
    importGithubRepo2GiteeRecurse(from_repo_url=args.from_repo_url,giteeMirrOrg=args.goal_org)

def importGithubRepo2GiteeRecurse(from_repo_url:str,giteeMirrOrg:str):
    ...
    time.sleep(2); print("调用gitee的接口后休眠2秒")
