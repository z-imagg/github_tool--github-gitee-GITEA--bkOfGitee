...
class GoalRpT:
    ...
    goal_rpLang:int) -> None:
        self.from_rpUrl:str=from_rpUrl
    ...
    @staticmethod
    def build(from_rpUrl:str,goal_rpOrg:str):
#举例:
# from_rpUrl:str="https://github.com/pytorch/QNNPACK.git"
...
# goal_rpLang:int=0
        ...
        thiz.from_rpUrl=from_rpUrl
        thiz.goal_rpOrg=goal_rpOrg
        thiz.goal_rpName=_fetch_goal_rpName(from_rpUrl)
        thiz.goal_rpDesc=f"【来源】{from_rpUrl}"
        thiz.goal_rpIsPub=True
        thiz.goal_rpLang=0
        return thiz

    def getDestGitUrl(self)->str:
        destGitUrl:str=f"https://gitee.com/{self.goal_rpOrg}/{self.goal_rpName}"
        return destGitUrl
